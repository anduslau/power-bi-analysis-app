#!/usr/bin/env python3
"""
Test the LLM pipeline with RDL file using DeepSeek API.
"""
...
def test_deepseek_rdl():
    """Test LLM pipeline with RDL file using DeepSeek."""
...
if __name__ == "__main__":
    print("=== LLM Pipeline Test with RDL (DeepSeek) ===\n")
    success = test_deepseek_rdl()
